...
export declare function registerPaymentInformationContributor(key: string, contributor: PaymentInformationContributor): void;
export declare function getPaymentInformationContributor(key: string): PaymentInformationContributor | undefined;
export declare function getPaymentInformationContributors(): Record<string, PaymentInformationContributor>;
/** Test helper — wipes the registry between specs. Not for production use. */
export declare function _resetPaymentInformationContributors(): void;
//# sourceMappingURL=paymentInformationContributors.d.ts.map