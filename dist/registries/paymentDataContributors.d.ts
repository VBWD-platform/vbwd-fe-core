 ...
 */
export declare function registerPaymentDataContributor(key: string, contributor: PaymentDataContributor): void;
export declare function getPaymentDataContributor(key: string): PaymentDataContributor | undefined;
export declare function getPaymentDataContributors(): Record<string, PaymentDataContributor>;
/** Test helper — wipes the registry between specs. Not for production use. */
export declare function _resetPaymentDataContributors(): void;
//# sourceMappingURL=paymentDataContributors.d.ts.map